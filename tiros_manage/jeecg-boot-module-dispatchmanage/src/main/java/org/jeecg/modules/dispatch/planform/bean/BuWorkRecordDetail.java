...
@ApiModel(value = "作业记录表明细对象", description = "作业记录表明细, 一条规程项关联一条或多条作业记录明细，如果是多条表示对这条规程项的拆分")
...
public class BuWorkRecordDetail extends Model<BuWorkRecordDetail> {
    ...
    @ApiModelProperty(value = "自检，用户ID")
    ...
    @ApiModelProperty(value = "自检，用户名")
    @TableField(exist = false)
    private String selfCheckName;

    @ApiModelProperty(value = "互检，用户名")
    @TableField(exist = false)
    private String guarderCheckName;

    @ApiModelProperty(value = "专检，用户名")
    @TableField(exist = false)
    private String monitorCheckName;

    @ApiModelProperty(value = "专工验收Id")
    @TableField(exist = false)
    private String monitorAcceptance;

    @ApiModelProperty(value = "专工验收，用户名")
    @TableField(exist = false)
    private String monitorAcceptanceName;
