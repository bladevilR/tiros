...
@TableName("bu_repair_plan_task_equ")
@ApiModel(value = "BuRepairPlanTaskEqu对象", description = "列计划任务目标设备")
public class BuRepairPlanTaskEqu extends Model<BuRepairPlanTaskEqu> {
