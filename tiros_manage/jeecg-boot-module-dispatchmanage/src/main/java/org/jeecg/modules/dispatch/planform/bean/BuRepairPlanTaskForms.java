...
@TableName("bu_repair_plan_task_forms")
@ApiModel(value = "BuRepairPlanTaskForms对象", description = "任务与表单的关联关系表")
public class BuRepairPlanTaskForms extends Model<BuRepairPlanTaskForms> {
    ...
    @ApiModelProperty(value = "计划表单id （计划表单记录bu_repair_plan_forms的id）")
