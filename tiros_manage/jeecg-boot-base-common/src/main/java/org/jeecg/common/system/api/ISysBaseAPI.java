...
public interface ISysBaseAPI {
    ...
    Map<String,String> mapAllUserIdRealName();
    ...
    /**
     * 根据类型和对象参数列表获取所属人员username
     *
     * @param type      类型 1=部门，2=角色，3=人员
     * @param paramList 对象参数 type=1部门时为部门id列表，type=2角色时为角色code列表，type=3人员时为人员id列表
     * @return 用户username
     */
    List<String> listUsernameByTypeAndParam(int type, List<String> paramList);
    ...
    String getDictItemTextByCodeAndValue(String code, String itemValue);
     ...
     * @param msgContent 消息内容
     */
    void sendScanCodeMsg(String toUser, String title, String msgContent);
