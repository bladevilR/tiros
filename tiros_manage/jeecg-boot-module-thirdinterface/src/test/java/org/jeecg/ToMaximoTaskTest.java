...
public class ToMaximoTaskTest {
     ...
     */
    @Test
    public void TransToMaximoTask() throws Exception {
        Date now = new Date();

        String transDataIds = "8a8a8b497acbad88017acbb4d952002e,8a8a8b497acbad88017acbb4d9530053";
        notTransToMaximoType = null;

        // 扫描maximo数据同步中间表数据
        List<BuMaximoTransData> transDataList = buMaximoTransDataService.listNeedTransTransDataByTransDataIds(transDataIds);
