...
public interface CommonConstant {
     ...
     * 接口请求成功，业务异常 599
     */
    String SC_SUCCESS_MESSAGE = "执行成功";
     ...
     * 我的二维码缓存KEY前缀
     */
    String PREFIX_MY_QRCODE = "USER#_";

    /**
     * 工单任务二维码缓存KEY前缀
     */
    String PREFIX_TASK_QRCODE = "TASK#_";

    /**
     * 任务工单已扫描状态缓存KEY前缀
     */
    String PREFIX_TASK_ISSCAN_QRCODE = "TASK#_IsScan_";
    ...
    String RESULT_OK = "操作成功!";
    String RESULT_ERROR = "操作失败!";
    String RESULT_EXIST = "数据已存在!";
