...
@TableName("JDX_MATUSETRANS_IN")
@ApiModel(value = "JdxMatusetransIn对象", description = "")
public class JdxMatusetransIn extends Model<JdxMatusetransIn> {
