...
//    /**
//     * 根据登录人班组id查询车间id，车辆段id，线路id(线路id多个逗号分割)
//     *
//     * @param groupId 班组id
//     * @return 车间id，车辆段id，线路id(线路id多个逗号分割)
//     */
//    BuMtrWorkshopGroup getWorkshopGroupByGroupId(String groupId);
//
//    /**
//     * 根据登录人车间id查询车间，车辆段id，线路id(线路id多个逗号分割)
//     *
//     * @param workshopId 车间id
//     * @return 车间，车辆段id，线路id(线路id多个逗号分割)
//     */
//    BuMtrWorkshop getWorkshopByWorkshopId(String workshopId);
