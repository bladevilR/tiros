...
import org.jeecg.modules.system.interceptor.CurrentTokeInterceptor;
...
public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    @Bean
    public CurrentTokeInterceptor currentTokeInterceptor() {
        return new CurrentTokeInterceptor();
    }
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/**")
                ...
                .addResourceLocations("file:" + getTirosTempPath() + "//")
    ...
    private String getTirosTempPath() {
        ...
        try {
            ...
            log.error("获取二维码文件夹绝对路径失败，错误信息如下：" + ex.getMessage());
        }
