...
@Slf4j
@RestController
@RequestMapping("/group/spare-part")
public class BuMaterialSparePartGroupController {

    private final BuMaterialSparePartGroupService buMaterialSparePartGroupService;

    public BuMaterialSparePartGroupController(BuMaterialSparePartGroupService buMaterialSparePartGroupService) {
