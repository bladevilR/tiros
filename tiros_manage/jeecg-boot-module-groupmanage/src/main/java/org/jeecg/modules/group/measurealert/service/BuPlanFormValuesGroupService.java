package org.jeecg.modules.group.measurealert.service;
 ...
 * @since 2020-11-23
 */
public interface BuPlanFormValuesGroupService extends IService<BuPlanFormValues> {
     ...
     * 测量预警修复关闭
     *
     * @param closeVO 测量预警id + 新的测量值 + 备注
     * @return 是否关闭成功
     * @throws Exception 异常信息
     */
    boolean close(BuWorkMeasureAlertCloseVO closeVO) throws Exception;
