...
import org.jeecg.modules.group.tool.bean.vo.BuMaterialToolsSetDutyUserVO;
...
@Slf4j
@RestController
@RequestMapping("/group/tool")
public class BuMaterialToolController {

    private final BuMaterialToolService buMaterialToolService;

    public BuMaterialToolController(BuMaterialToolService buMaterialToolService) {
    ...
    @ApiOperation(value = "设置责任人员")
    @OperationLog(operateType = CommonConstant.OPERATE_TYPE_3)
    public Result<Boolean> setDutyUser(@RequestBody @Validated BuMaterialToolsSetDutyUserVO setDutyUserVO) throws Exception {
        boolean flag = buMaterialToolService.setDutyUser(setDutyUserVO.getId(), setDutyUserVO.getUserId());
