...
@ApiModel(value = "BuJobGuideBookTools对象", description = "作业指导书步骤工器具")
@TableName("bu_job_guide_book_tools")
public class BuJobGuideBookTools extends Model<BuJobGuideBookTools> {
    ...
    @ApiModelProperty(value = "工器具类型id", required = true)
    @NotBlank
