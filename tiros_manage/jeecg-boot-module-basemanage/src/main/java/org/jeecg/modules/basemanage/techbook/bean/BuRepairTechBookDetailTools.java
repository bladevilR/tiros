...
@ApiModel(value = "BuRepairTechBookDetailTools对象", description = "作业指导书(工艺)明细步骤工器具")
@TableName("bu_repair_tech_book_tools")
public class BuRepairTechBookDetailTools extends Model<BuRepairTechBookDetailTools> {
    ...
    @ApiModelProperty(value = "工期具类型id", required = true)
    @NotBlank
