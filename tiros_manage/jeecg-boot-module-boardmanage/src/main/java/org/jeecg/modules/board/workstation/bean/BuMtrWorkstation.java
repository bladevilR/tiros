package org.jeecg.modules.board.workstation.bean;
...
@ApiModel(value = "BuMtrWorkstation对象", description = "工位信息")
...
public class BuMtrWorkstation extends Model<BuMtrWorkstation> {
    ...
    @ApiModelProperty(value = "状态 0无效 1有效  字典dictCode=bu_valid_status")
