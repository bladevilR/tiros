package org.jeecg.modules.board.quality.bean;
 ...
 * <p>
 * 故障统计-中间表-系统维度
 * 以系统为基本统计单位，后台程序，每天自动统计所有的故障数据写入对应车辆
 * </p>
 *
 * @author zhaiyantao
 * @since 2020-11-12
...
@ApiModel(value = "BuRptBoardSysFault对象", description = "故障统计-中间表-系统维度 以系统为基本统计单位，后台程序，每天自动统计所有的故障数据写入对应车辆")
@TableName("bu_rpt_board_sys_fault")
public class BuRptBoardSysFault extends Model<BuRptBoardSysFault> {
