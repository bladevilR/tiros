...
public class BuFaultInfo extends Model<BuFaultInfo> {
    ...
    @ApiModelProperty(value = "发现阶段 1架修期 2质保期 3出保期   字典dictCode=bu_fault_phase", required = true)
    @NotNull
    ...
    @ApiModelProperty(value = "接修序号 表示第几列车")
    @TableField(exist = false)
    ...
    @ApiModelProperty(value = "处理措施描述  处理记录处理措施组合而成")
    @TableField(exist = false)
    private String handleDesc;

    @ApiModelProperty(value = "处理人  处理记录处理措施组合而成")
    @TableField(exist = false)
