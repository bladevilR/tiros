package org.jeecg.modules.report.utils;
...
public class ExcelUtils {
     ...
     * @throws IOException
     */
    public static ResponseEntity<byte[]> exportLuckySheetXlsx(String excelData,HttpServletRequest request, HttpServletResponse response)  {
        ...
        try {
          /*  String disposition = "attachment;filename=";
            ...
            OutputStream outputStream = new FileOutputStream("c:\\test.xlsx");;
