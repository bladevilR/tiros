...
public class BuMaterialTypeTool extends Model<BuMaterialTypeTool> {
    ...
    @ApiModelProperty(value = "0无效 1 有效")
    @Dict(dicCode = "bu_valid_status")
    private Integer status;

    @ApiModelProperty(value = "种类 1物料 2工器具")
    ...
    @ApiModelProperty(value = "物料分类  字典dictCode=bu_tools_type")
