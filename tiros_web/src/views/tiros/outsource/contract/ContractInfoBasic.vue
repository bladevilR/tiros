          ...
          <a-row :gutter="24">
            <a-col :md="6" :sm="24" :offset="3">
              <a-form-item :labelCol="labelCol1" :wrapperCol="wrapperCol1" label="合同编号">
                <a-input disabled placeholder="合同编号" v-decorator="['contractNo', validatorRules.contractNo]" />
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item :labelCol="labelCol1" :wrapperCol="wrapperCol1" label="合同名称">
                <a-input disabled placeholder="合同名称" v-decorator="['contractName', validatorRules.contractName]" />
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item :labelCol="labelCol1" :wrapperCol="wrapperCol1" label="合同厂商">
                <!--                  <j-dict-select-tag
                  ...
                  />-->
                <a-input disabled placeholder="合同厂商" v-decorator="['supplierName', validatorRules.supplierName]" />
              </a-form-item>
            </a-col>
          </a-row>
          <a-row :gutter="24">
          ...
          <a-row :gutter="24">
            ...
            <a-col :md="6" :sm="24" >
              <a-form-item :labelCol="labelCol1" :wrapperCol="wrapperCol1" label="合同部件别名">
                <a-input  disabled placeholder="合同部件别名" v-decorator="['assetTypeAlias',validatorRules.assetTypeAlias]" />
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24" :offset="3">
              <a-form-item :labelCol="labelCol1" :wrapperCol="wrapperCol1" label="每列部件数量">
                <a-input
                  disabled
                  placeholder="每列部件数量"
                  v-decorator="['assetAmount', validatorRules.assetAmount]"
                />
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24" >
            ...
            <a-col :md="6" :sm="24" >
              <a-form-item :labelCol="labelCol1" :wrapperCol="wrapperCol1" label="计数开始">
                <a-input-number   disabled :min="1" style="width: 100%" placeholder="从第几列开始计算" v-decorator="['payBegin']" />
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item :labelCol="labelCol1" :wrapperCol="wrapperCol1" label="支付间隔数">
                <a-input-number  disabled :min="1" style="width: 100%" placeholder="每隔多少列支付一次" v-decorator="['payInterval']" />
              </a-form-item>
            </a-col>
          </a-row>
          <a-row :gutter="24" >
            ...
            <a-col :md="6" :sm="24" >
              <a-form-item :labelCol="labelCol1" :wrapperCol="wrapperCol1" label="签订日期">
                <a-date-picker style="width: 100%"    disabled placeholder="签订日期" v-decorator="['signDate']" />
              </a-form-item>
            </a-col>
              ...
              >
                ...
                <vxe-table-column title="操作" width="160px" header-align="center" align="center">
                  <template v-slot="{ row }">
                    ...
                    <a @click.stop="handleDownload(row)" style="margin-left: 12px">下载</a>
                  </template>
                </vxe-table-column>
              </vxe-table>
            </a-col>
...
export default {
  name: 'ContractInfoBasic',
  components: { JTreeSelect, TrainAssetType, LineSelectList, DocUpload, DocPreviewModal },
  ...
  methods: {
    handleLine(value) {
      if (everythingIsEmpty(value)) {
        ...
        getLineInfo({ lineId: value }).then((res) => {
          if (res.success) {
    ...
    openModal() {
      if (everythingIsEmpty(this.trainTypeId)) {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          let p = Object.assign({}, this.model, values, {
            ...
            finishDate: moment(values.applyDate).format('YYYY-MM-DD'),
