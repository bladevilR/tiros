  ...
  <div class="bodyWrapper">
    ...
    <div style="height: calc(100vh - 225px)">
      ...
      >
        ...
        <vxe-table-column field="code" align="left" header-align="center"  title="工装编码" width="120"></vxe-table-column>
    ...
    <maintain-modal ref="modalForm" @ok="loadData()"></maintain-modal>
  </div>
</template>
...
<script>
  ...
  import MaintainModal from '../modules/MaintainModal'
  import TableBtnUtil from '@views/tiros/util/TableBtnUtil'

  export default {
    name: 'MaintainPage',
    components: { MaintainModal },
    data() {
      return {
        queryParam: {
          name: '',
