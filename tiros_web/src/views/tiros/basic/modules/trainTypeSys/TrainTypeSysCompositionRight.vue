...
<!--          <a-col :md="6" :sm="24">
          ...
          <a-col>
            <span class="table-page-search-submitButtons">
              <a-space>
                ...
                <a-button :disabled="!(records.length == 1 && records[0].parentId )" @click="handleEdit(records[0])">编辑</a-button>
    ...
    <div style="height: calc(100% - 67px);">
      <vxe-table
        ...
        <vxe-table-column field="code" align="left" header-align="center" title="编码" width="120"></vxe-table-column>
...
export default {
  ...
  name: 'TrainTypeSysCompositionRight',
  ...
  watch: {
    value: {
      ...
      handler (info) {
        ...
        this.queryParam.trainTypeId = info ? info.trainTypeId : ''
        this.selectParent = info ? info : {}
        this.queryParamId = ''
        this.dataSource = []
       // if (!everythingIsEmpty(this.queryParam.trainTypeId)) {
          this.findList()
         // this.findSelectList()
        //}
      }
