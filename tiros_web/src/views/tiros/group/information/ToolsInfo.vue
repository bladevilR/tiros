  ...
  <div>
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="7" :sm="8">
            <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
              ...
              <a-button type="primary" @click="handleAdd" style="margin-left: 8px" v-has="'group:info:tool:add'">添加工器具</a-button>
            </span>
          </a-col>
        </a-row>
      </a-form>
    ...
    <div style="height: calc(100vh - 215px)">
      ...
      >
        ...
        <vxe-table-column field="code" title="工器具类型编码" width="200"></vxe-table-column>
        <vxe-table-column field="name" title="工器具名称" width="200"></vxe-table-column>
...
<!--    <add-tools-info-modal ref="modalForm" @ok="loadData()" :datagroup="Group"></add-tools-info-modal>-->
    <tools-list ref="tools" :multiple="true" :canSelectType="[4]" @ok="addTarget"></tools-list>
  </div>
</template>

<script>
import { addTools, getToolList } from '@api/tirosGroupApi'
import Vue from 'vue'
