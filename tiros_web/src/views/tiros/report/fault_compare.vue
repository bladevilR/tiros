<template>
  <div class="bodyWrapper" id="errorMonitorContent" style="padding: 8px">
    <!-- 新版查询面板 -->
    <div class="table-page-search-wrapper">
      ...
      <a-form layout="inline">
        ...
        <a-row :gutter="24">
          <a-col :md="4">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="车辆段">
              <j-dict-select-tag v-model="query1.depotId" placeholder="请选择" dictCode="bu_mtr_depot,name,id" />
            </a-form-item>
          </a-col>
          <a-col :md="4">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="线路">
              <line-select-list v-model="lineId1" :trigger-change="true" @change="handleLineLeft"></line-select-list>
            </a-form-item>
          </a-col>
          <a-col :md="4">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="车辆">
              <j-dict-select-seach-tag v-model="query1.trainNo" @focus="handleSysFocus" :dictCode="dictTrainStr1" />
            </a-form-item>
          </a-col>
          <a-col :md="4">
          ...
          <a-col :md="4">
            <a-space>
              <a-button @click="compareFaultDiff">查询</a-button>
          ...
          <a-col :md="4">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="部件" style="padding-left: 14px">
              <a-select
                ...
                :open="false"
                :showArrow="true"
                @change="allowClearCHange($event, 1)"
                @dropdownVisibleChange="showTrainAssetType(1)"
          ...
          <a-col :md="14" :xl="8">
            ...
            <!-- <a-row :gutter="24">
              ...
              <a-col :md="6" v-if="query1.dateType === '2'">
                <a-form-item>
                  <j-dict-select-tag v-model="query1.quarter" placeholder="请选择" dictCode="bu_quarter_type" />
                </a-form-item>
              </a-col>
              <a-col :md="14" v-if="query1.dateType === '3'">
                <a-form-item>
                  <a-month-picker :style="{ width: '100%' }" placeholder="选择月份" v-model="month1"> </a-month-picker>
                </a-form-item>
              </a-col>
              <a-col :md="14" v-if="query1.dateType === '4'">
                <a-form-item>
                  <a-range-picker v-model="rangeDate1" :defaultPickerValue="defaultDateRange" > </a-range-picker>
                </a-form-item>
              </a-col>
            </a-row> -->
          </a-col>
        ...
        <!-- 第三行 -->
        <a-row :gutter="24" v-if="moreVisible" type="flex">
          <a-col :sm="12" flex="1000px">
            <a-form-item label="故障种类">
              <a-checkbox-group v-model="faultTypes1" style="width: 90%">
                <a-checkbox value="1"> 架修期故障 </a-checkbox>
                <a-checkbox value="2"> 架修期A/B故障 </a-checkbox>
                <a-checkbox value="3"> 质保期故障 </a-checkbox>
                <a-checkbox value="4"> 质保期A/B故障 </a-checkbox>
                <a-checkbox value="5"> 质保期正线故障 </a-checkbox>
                <a-checkbox value="6"> 质保期正线有责故障 </a-checkbox>
              </a-checkbox-group>
            </a-form-item>
          </a-col>
          <a-col :md="4" :sm="24">
            <a-form-item label="是否比较分析">
              <a-switch v-model="compare" @change="onChoose"></a-switch>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
      ...
      <a-form layout="inline" v-if="moreVisible && compare">
        ...
        <a-row :gutter="24">
          <a-col :md="4">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="车辆段">
              <j-dict-select-tag v-model="query2.depotId" placeholder="请选择" dictCode="bu_mtr_depot,name,id" />
            </a-form-item>
          </a-col>
          <a-col :md="4">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="线路">
              <line-select-list v-model="lineId2" :trigger-change="true" @change="handleLineRight"></line-select-list>
            </a-form-item>
          </a-col>
          <a-col :md="4">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="车辆">
              <j-dict-select-seach-tag v-model="query2.trainNo" :dictCode="dictTrainStr2" />
            </a-form-item>
          </a-col>
          <a-col :md="4">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="系统">
          ...
          <a-col :md="4">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="部件" style="padding-left: 14px">
              <a-select
                ...
                :open="false"
                :showArrow="true"
                @change="allowClearCHange($event, 2)"
                @dropdownVisibleChange="showTrainAssetType(2)"
          ...
          <a-col :md="14" :xl="8">
            ...
            <!-- <a-row :gutter="24">
              ...
              <a-col :md="6" v-if="query2.dateType === '2'">
                <a-form-item>
                  <j-dict-select-tag v-model="query2.quarter" placeholder="请选择" dictCode="bu_quarter_type" />
                </a-form-item>
              </a-col>
              <a-col :md="14" v-if="query2.dateType === '3'">
                <a-form-item>
                  <a-month-picker :style="{ width: '100%' }" placeholder="选择月份" v-model="month2"> </a-month-picker>
                </a-form-item>
              </a-col>
              <a-col :md="14" v-if="query2.dateType === '4'">
                <a-form-item>
                  <a-range-picker v-model="rangeDate2" :defaultPickerValue="defaultDateRange" > </a-range-picker>
                </a-form-item>
              </a-col>
            </a-row> -->
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="24">
            <a-form-item label="故障种类">
              <a-checkbox-group v-model="faultTypes2" style="width: 100%">
                <a-checkbox value="1"> 架修期故障 </a-checkbox>
                <a-checkbox value="2"> 架修期A/B故障 </a-checkbox>
                <a-checkbox value="3"> 质保期故障 </a-checkbox>
                <a-checkbox value="4"> 质保期A/B故障 </a-checkbox>
    ...
    <div class="chartsDiv">
      ...
      <a-row :gutter="12">
        <a-col :span="compare ? 12 : 24" style="border-right: 1px dashed #aaa">
          <a-row>
          ...
          <a-row>
            <div v-if="!jxList.length && !zbList.length && !cbList.length && !jxListR.length && !zbListR.length && !cbListR.length"
          ...
          <a-row v-if="jxList.length">
            <a-col :span="24">
              <bar-horizontal :title="`${query1.trainNo ? query1.trainNo + '车' : query1.lineId ? query1.lineId + '号线' : ''}架修期系统故障分布`" :dataSource="leftBarDataSource1" :id="'barChart01'" />
            </a-col>
            <a-col :span="24">
              <pie :title="`${query1.trainNo ? query1.trainNo + '车' : query1.lineId ? query1.lineId + '号线' : ''}架修期系统故障占比`" :dataSource="leftPieDataSource1" :id="'pieChart01'" />
            </a-col>
          </a-row>
          <a-row v-if="zbList.length">
            <a-col :span="24">
              <bar-horizontal :title="`${query1.trainNo?query1.trainNo + '车' : query1.lineId ? query1.lineId + '号线' : ''}质保期系统故障分布`" :dataSource="leftBarDataSource2" :id="'barChart02'" />
            </a-col>
            <a-col :span="24">
              <pie :title="`${query1.trainNo?query1.trainNo + '车' : query1.lineId ? query1.lineId + '号线' : ''}质保期系统故障占比`" :dataSource="leftPieDataSource2" :id="'pieChart02'" />
            </a-col>
          </a-row>
          <a-row v-if="cbList.length">
            <a-col :span="24">
              <bar-horizontal :title="`${query1.trainNo?query1.trainNo + '车' : query1.lineId ? query1.lineId + '号线' : ''}出保期系统故障分布`" :dataSource="leftBarDataSource3" :id="'barChart03'" />
            </a-col>
            <a-col :span="24">
              <pie :title="`${query1.trainNo?query1.trainNo + '车' : query1.lineId ? query1.lineId + '号线' : ''}出保期系统故障占比`" :dataSource="leftPieDataSource3" :id="'pieChart03'" />
            </a-col>
          </a-row>
        </a-col>
        <a-col :span="compare ? 12 : 24" style="border-right: 1px dashed #aaa">
          ...
          <a-row>
            <div v-if="compare && !jxList.length && !zbList.length && !cbList.length && !jxListR.length && !zbListR.length && !cbListR.length"
              style="text-align: center; margin-top: 30px">
              暂无数据
            </div>
          </a-row>
          <a-row v-if="jxListR.length">
            <a-col :span="24">
              <bar-horizontal :title="`${query2.trainNo?query2.trainNo + '车' : query2.lineId ? query2.lineId + '号线' : ''}架修期系统故障分布`" :dataSource="rightBarDataSource1" :id="'barChart11'" />
            </a-col>
            <a-col :span="24">
              <pie :title="`${query2.trainNo?query2.trainNo + '车' : query2.lineId ? query2.lineId + '号线' : ''}架修期系统故障占比`" :dataSource="rightPieDataSource1" :id="'pieChart11'" />
            </a-col>
          </a-row>
          <a-row v-if="zbListR.length">
            <a-col :span="24">
              <bar-horizontal :title="`${query2.trainNo?query2.trainNo + '车' : query2.lineId ? query2.lineId + '号线' : ''}质保期系统故障分布`" :dataSource="rightBarDataSource2" :id="'barChart12'" />
            </a-col>
            <a-col :span="24">
              <pie :title="`${query2.trainNo?query2.trainNo + '车' : query2.lineId ? query2.lineId + '号线' : ''}质保期系统故障占比`" :dataSource="rightPieDataSource2" :id="'pieChart12'" />
            </a-col>
          </a-row>
          <a-row v-if="cbListR.length">
            <a-col :span="24">
              <bar-horizontal :title="`${query2.trainNo?query2.trainNo + '车' : query2.lineId ? query2.lineId + '号线' : ''}出保期系统故障分布`" :dataSource="rightBarDataSource3" :id="'barChart13'" />
            </a-col>
            <a-col :span="24">
              <pie :title="`${query2.trainNo?query2.trainNo + '车' : query2.lineId ? query2.lineId + '号线' : ''}出保期系统故障占比`" :dataSource="rightPieDataSource3" :id="'pieChart13'" />
            </a-col>
          </a-row>
        </a-col>
      </a-row>
    ...
    <CarDeviceSelect
      :canSelectType="[3, 4]"
      :trainNo="type == 1 ? query1.trainNo : query2.trainNo"
      ref="trainAssetTypeModal"
      :multiple="false"
      @ok="handleTrainAssetType"
    />
...
import { getFaultCompare } from '@/api/tirosProductionApi'
...
export default {
  ...
  components: { BarHorizontal, Pie, LineSelectList, NaSelectDate, CarDeviceSelect },
  data() {
    return {
      compare: false,
      moreVisible: false,
  ...
  methods: {
    ...
    allowClearCHange(e, type) {
      if (!e) {
        // 清空
        if (type == 1) {
          this.query1.assetId = undefined
          this.assetNameLeft = undefined
        } else {
          this.query2.assetId = undefined
          this.assetNameRight = undefined
        }
      }
    },
    handleTrainAssetType(data) {
      if (!everythingIsEmpty(data)) {
        if (this.type == 1) {
          ...
          this.assetNameLeft = data[0].structDetailName
        } else {
          this.query2.assetId = data[0].id
          this.assetNameRight = data[0].structDetailName
        }
      }
    },
    ...
    compareFaultDiff() {
      ...
      // return
      getFaultCompare(this.queryParam).then((res) => {
        if (res.success) {
          this.result1Title = res.result.result1Title
          this.result2Title = res.result.result2Title
    ...
    handleResetTimeQuery1() {
      ...
      // if (this.query1.dateType) {
      //   switch (Number(this.query1.dateType)) {
      //     case 1:
      //       if (!this.year1) {
      //         this.year1 = moment(new Date()).format('YYYY')
      //       }
      //       this.query1.year = moment(this.year1).format('YYYY')
      //       break;
      //     case 2:
      //       if (!this.year1) {
      //         this.year1 = moment(new Date()).format('YYYY')
      ...
      //     case 3:
      //       if (!this.month1) {
      //         this.year1 = moment(new Date()).format('YYYY-MM')
      //       }
      //       this.query1.year = moment(this.year1).format('YYYY')
      //       this.query1.month1 = moment(this.year1).format('MM')
      //       break;
      //     case 1:
      //       if (!this.year1) {
      //         this.year1 = moment(new Date()).format('YYYY')
    ...
    dateChange1(value) {
      if (value.dateType) {
        this.query1.dateType = value.dateType
        this.query1.year = value.year
        this.query1.quarter = value.quarter
        this.query1.month = value.month
        this.query1.startDate = value.dateRef[0]
        this.query1.endDate = value.dateRef[1]
      } else {
        this.query1.dateType = null
        this.query1.year = null
        this.query1.quarter = null
        this.query1.month = null
        this.query1.startDate = null
        this.query1.endDate = null
      }
    },
    dateChange2(value) {
      if (value.dateType) {
        this.query2.dateType = value.dateType
        this.query2.year = value.year
        this.query2.quarter = value.quarter
        this.query2.month = value.month
        this.query2.startDate = value.dateRef[0]
        this.query2.endDate = value.dateRef[1]
      } else {
        this.query2.dateType = null
        this.query2.year = null
        this.query2.quarter = null
        this.query2.month = null
        this.query2.startDate = null
        this.query2.endDate = null
      }
    },
  },
  computed: {
