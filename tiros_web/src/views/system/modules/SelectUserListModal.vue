<template>
  ...
  >
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :span="6">
              <a-form-item label="部门">
                <j-select-depart v-model="queryParam.depId" :rootOpened="false" />
              </a-form-item>
            </a-col>
          </template>
    ...
    <!-- 2021-05-08 修改使用vxe-table -->
    <div class="table-page-body-wrapper" style="height: 500px">
      <div class="table-body-context">
        ...
        >
          ...
          <vxe-table-column field="username" title="用户账号" min-width="80px" />
          <vxe-table-column field="realname" title="用户名称" min-width="80px" />
          <vxe-table-column field="sex" title="性别" min-width="80px" />
          <vxe-table-column field="phone" title="手机号码" min-width="80px" />
          <vxe-table-column field="email" title="邮箱" min-width="80px" />
          <vxe-table-column field="status" title="状态" min-width="80px" />
        </vxe-table>
      </div>
      <vxe-pager
        perfect
...
export default {
  ...
  methods: {
    ...
    handleOk() {
      this.selectionRows = this.$refs.listTable.getCheckboxRecords()
