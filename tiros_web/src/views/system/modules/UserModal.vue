      ...
      <a-form :form="form">
       ...
       <!-- update--begin--autor:wangshuai-----date:20200108------for：新增身份和负责部门------ -->
        ...
        <a-form-item label="座机" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入座机" v-decorator="[ 'telephone']"/>
        </a-form-item>
<!--
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        that.$nextTick(() => {
          that.form.setFieldsValue(pick(this.model,'username','sex','realname','email','phone','workNo','telephone','post')) // 'activitiSync',
        });
        //身份为上级显示负责部门，否则不显示
