    ...
    >
      <div class="setting-drawer-index-content">
          ...
          <div class="setting-drawer-index-blockChecbox">
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleMenuTheme('dark')">
                <img src="~@/assets/tiros/images/menu_black.svg" alt="dark">
            ...
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleMenuTheme('light')">
                <img src="~@/assets/tiros/images/menu_white.svg" alt="light">
                <div class="setting-drawer-index-selectIcon" v-if="navTheme !== 'dark'">
                  <a-icon type="check"/>
                </div>
              </div>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div class="setting-drawer-index-blockChecbox">
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleLayout('sidemenu')">
                <img src="~@/assets/tiros/images/layout_left.svg" alt="sidemenu">
            ...
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleLayout('topmenu')">
                <img src="~@/assets/tiros/images/layout_top.svg" alt="topmenu">
            ...
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleLayout('mixmenu')">
                <img src="~@/assets/tiros/images/layout_mix.svg" alt="mixmenu">
          ...
          <div :style="{ marginTop: '24px' }" v-if="false">
            <a-list :split="false">
              <a-list-item>
